var lonad = (function (exports) {
    ...
    */
    ...
    class NoneClass extends Optional {
        ...
        or(replacement) {
            return (isFunction$1(replacement))
                ? replacement()
                : replacement;
        }
        match(clauses) {
    ...
    class SomeClass extends Optional {
        ...
        optionalProperty(property) {
            return isObject$1(this.value) ? this.value[property] : undefined;
        }
        nullableProperty(property) {
            return Optional.fromNullable(isObject$1(this.value) ? this.value[property] : undefined);
        }
        flatMap(λ) {
            return λ(this.value);
        }
        ...
        property(property) {
            return Optional.Some(isObject$1(this.value) ? this.value[property] : undefined);
        }
        satisfies(λ) {
    ...
    function tryAsync(λ) {
        return lodash_flow(doTry, Result.asynchronous)(λ);
    }
    /**
    ...
    * Will only test the predicate if the result is Ok.
    ...
    class PendingClass extends AsyncResult {
        ...
        getOrElse(value) {
            return lodash_flow(this.callWrappedResultMethod('getOrElse'), property('promise'))(value);
        }
        recover(λ) {
        ...
        satisfies(predicate) {
            return lodash_flow(this.callWrappedResultMethod('satisfies'), property('promise'))(predicate);
        }
        valueEquals(value) {
            return lodash_flow(this.callWrappedResultMethod('valueEquals'), property('promise'))(value);
        }
        map(λ) {
        ...
        merge() {
            return lodash_flow(this.callWrappedResultMethod('merge'), property('promise'))();
        }
        reject(predicate) {
        ...
        match(callbacks) {
            return lodash_flow(this.callWrappedResultMethod('match'), property('promise'))(callbacks);
        }
        abortOnErrorWith(λOrValue) {
        ...
        toOptional() {
            return lodash_flow(this.callWrappedResultMethod('toOptional'), property('promise'))();
        }
        /**
...
//# sourceMappingURL=lonad-bundle.js.map
