 ...
 * // throws Error
 */
export function fromParsedJson(object) {
 ...
 * // optional === Optional.None()
 */
export function when(truthy, value) {
 ...
 * // optional === Optional.Some(1)
 */
export function first(optionals) {
 ...
 * // optional === Optional.Some([1, 2, 3])
 */
export function values(optionals) {
 ...
 */
export function isSome(optional) {
 ...
 * // isNone(optional) === true
 */
export function isNone(optional) {
