...
expectType<number>(someOptional_number.flatMap(x => 6))
expectType<string>(someOptional_number.flatMap(x => 'hello world'))
expectType<Optional<string>>(someOptional_number.flatMap(x => Optional.Some('hello world')))
